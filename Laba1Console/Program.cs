// Консольное приложение для управления компонентами и спецификациями.
// Содержит парсер команд, взаимодействие с `SpecificationManager` и утилиты для тестирования.
// Выводит подсказку PS> и ожидает команд от пользователя.
// Поддерживаемые команды описаны в методе `PrintHelp`.
